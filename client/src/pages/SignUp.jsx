...
const LoadingIndicator = () => (
  <div className="w-8 h-8 border-4 border-t-4 border-gray-300 dark:border-gray-600 border-solid rounded-full animate-spin" aria-live="assertive" aria-busy="true"></div>
